...
class PagamentoService {
  async createPagamento(data) {
    try {
      ...
      const existingPagamento = await pagamentoRepository.findByAluguelId(aluguelId);
  ...
  async updatePagamento(id, data) {
    try {
      ...
      if (data.aluguelId) {
        ...
        const existingPagamento = await pagamentoRepository.findByAluguelId(data.aluguelId);
